...
const DeliveryOrder = () => {
  ...
  return (
    <>
      ...
      <div className="w-full max-w-6xl bg-white rounded-lg shadow-md flex flex-col md:flex-row mt-5">
        {/* Left Section */}
        <div className="w-full md:w-[60%] p-5 border-r border-gray-300">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-">
            <input {...register("dial_code")} type="text" className="hidden" />
                ...
                <div>
                  <input
                    ...
                    {...register("phone_number", {
                      ...
                      pattern: {
                        value: /^[1-9][0-9]{8}$/,
                        message: "Phone must be 9 digits and not start with 0",
                      },
                    })}
                    type="tel"
